...
export const formFields: FormFieldType[] = [
    { name: "projectname", label: "Project Name", placeholder: "Devfinder", type: "text" },
    { name: "projectdescription", label: "Project Description", placeholder: "A Collaborative Environment For developers all over the world to communicate.", type: "textarea" },
    { name: "projectgithub", label: "Project Github", placeholder: "https://github.com/your-username/your-project", type: "text" },
    { name: "projectlivelink", label: "Project Live Link", placeholder: "https://skumar.devfinder.site", type: "text" },
    { name: "issue", label: "Issue You are facing", placeholder: "Enter the Issue you are facing", type: "text" },
    { name: "tags", label: "Project Tags", placeholder: "typescript,websockets,...", type: "text", description: "Enter the Technologies Used in this project." },
  ];
  ...
  export const REPO_GITHUB_URL="https://github.com/isakshamkumar/DevFinder"